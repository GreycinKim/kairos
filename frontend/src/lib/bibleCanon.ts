/** Protestant canon chapter counts (WEB / bible-api.com naming). */
export const CHAPTER_COUNT: Record<string, number> = {
  Genesis: 50,
  Exodus: 40,
  Leviticus: 27,
  Numbers: 36,
...
/** Protestant canon book names in canonical order (66 books). */
export const ALL_BIBLE_BOOKS: string[] = [
  "Genesis",
  "Exodus",
  "Leviticus",
  "Numbers",
